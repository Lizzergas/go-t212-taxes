...
[![CI/CD](https://github.com/Lizzergas/t212-taxes/workflows/CI%2FCD%20Pipeline/badge.svg)](https://github.com/Lizzergas/t212-taxes/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/Lizzergas/t212-taxes)](https://goreportcard.com/report/github.com/Lizzergas/t212-taxes)
[![codecov](https://codecov.io/gh/Lizzergas/t212-taxes/branch/main/graph/badge.svg)](https://codecov.io/gh/Lizzergas/t212-taxes)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Go Version](https://img.shields.io/github/go-mod/go-version/Lizzergas/t212-taxes)](https://github.com/Lizzergas/t212-taxes)
[![Release](https://img.shields.io/github/v/release/Lizzergas/t212-taxes)](https://github.com/Lizzergas/t212-taxes/releases)
[![Docker](https://img.shields.io/badge/docker-available-blue.svg)](https://github.com/Lizzergas/t212-taxes/pkgs/container/t212-taxes)
...
```bash
# macOS (Apple Silicon)
curl -L https://github.com/Lizzergas/t212-taxes/releases/latest/download/t212-taxes-darwin-arm64 -o t212-taxes
chmod +x t212-taxes

# macOS (Intel)
curl -L https://github.com/Lizzergas/t212-taxes/releases/latest/download/t212-taxes-darwin-amd64 -o t212-taxes
chmod +x t212-taxes

# Linux (x64)
curl -L https://github.com/Lizzergas/t212-taxes/releases/latest/download/t212-taxes-linux-amd64 -o t212-taxes
chmod +x t212-taxes

# Windows (x64)
curl -L https://github.com/Lizzergas/t212-taxes/releases/latest/download/t212-taxes-windows-amd64.exe -o t212-taxes.exe
```

### Go Install

```bash
go install github.com/Lizzergas/t212-taxes/cmd/t212-taxes@latest
```
...
```bash
# Run directly
docker run --rm -v $(pwd)/exports:/app/data ghcr.io/Lizzergas/t212-taxes:latest analyze --dir /app/data

# Interactive mode
docker run --rm -it -v $(pwd)/exports:/app/data ghcr.io/Lizzergas/t212-taxes:latest
```

### From Source

```bash
git clone https://github.com/Lizzergas/t212-taxes.git
cd t212-taxes
...
- **Issues**: Report bugs and feature requests on [GitHub Issues](https://github.com/Lizzergas/t212-taxes/issues)
- **Discussions**: Join our [GitHub Discussions](https://github.com/Lizzergas/t212-taxes/discussions)
